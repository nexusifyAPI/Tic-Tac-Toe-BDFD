...
$ephemeral
$removeButtons
$description[❌ Voce nao pode usar este menu, nao e seu!]
$stop
$endif
$defer
$var[diffName;Facil]
...
$endif
$if[$var[dif]==i]
$var[diffName;Impossivel]
$var[diffColor;#ED4245]
$endif
$title[Jogo vs IA - Nivel: $var[diffName]]
$var[rnd;$random[0;2]]
$if[$var[rnd]==0]
$description[Jogador: <@$authorID> (❌)
IA: 🤖 (⭕)
...
$addButton[yes;act;🏳️ Render-se;danger;no;🏳️]
$else
$description[IA: 🤖 (❌)
Jogador: <@$authorID> (⭕)
...
$ephemeral
$removeButtons
$description[❌ ❌ Apenas <@$var[retado]> pode aceitar este desafio!]
$stop
$endif
$defer
$var[rnd;$random[0;2]]
$if[$var[rnd]==0]
$title[Jogo PvP - Jogo da Velha]
$description[Jogador ❌: <@$var[retador]>
Jogador ⭕: <@$var[retado]>
...
$else
$title[Jogo PvP - Jogo da Velha]
$description[Jogador ❌: <@$var[retado]>
Jogador ⭕: <@$var[retador]>
...
$ephemeral
$removeButtons
$description[❌ ❌ Apenas <@$var[retado]> pode rejeitar este desafio!]
$stop
$endif
$defer
$title[Desafio rejeitado]
$description[❌ <@$var[retado]> rejeitou <@$var[retador]>.]
$color[#ED4245]
$removeAllComponents
$stop
$endif
...
$ephemeral
$removeButtons
$description[❌ Nao foi possivel carregar o estado do jogo.]
$stop
$endif
...
$ephemeral
$removeButtons
$description[❌ Apenas o jogador pode reiniciar!]
$stop
$endif
$else
$if[$authorID!=$var[pX]]
...
$ephemeral
$removeButtons
$description[❌ Apenas os jogadores deste jogo podem pedir revanche!]
$stop
$endif
$endif
...
$ephemeral
$removeButtons
$description[❌ Voce ja votou para revanche!]
$stop
$endif
$var[revX;y]
$endif
...
$title[Jogo PvP - Revanche]
$description[Jogador ❌: <@$var[pX]>
Jogador ⭕: <@$var[pO]>

🔄 Revanche solicitada: **$var[votos]/2**

Ambos os jogadores devem pressionar para reiniciar.]
$color[#FEE75C]
...
$ephemeral
$removeButtons
$description[❌ Apenas o jogador pode render-se!]
$stop
$endif
$else
$if[$authorID!=$var[pX]]
...
$ephemeral
$removeButtons
$description[❌ Nao e seu turno, voce nao pode render-se!]
$stop
$endif
$endif
...
$if[$var[mode]==ia]
$title[Jogo vs IA - Rendicao]
$if[$var[pX]==AI]
$description[IA: 🤖 (❌)
Player: <@$var[pO]> (⭕)

🏳️ <@$var[pO]> rendeu-se. A IA venceu!]
$else
$description[Player: <@$var[pX]> (❌)
IA: 🤖 (⭕)

🏳️ <@$var[pX]> rendeu-se. A IA venceu!]
$endif
$color[#ED4245]
$else
$var[winner;$var[pX]]
...
$var[winnerSym;O]
$endif
$title[Jogo PvP - Rendicao]
$description[Jogador ❌: <@$var[pX]>
Jogador ⭕: <@$var[pO]>

🏳️ <@$authorID> rendeu-se. $var[winnerSym] <@$var[winner]> venceu!]
$color[#57F287]
$endif
